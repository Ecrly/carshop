...
// 数据源配置
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/onlinetaxi?useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//	    strategy.setCapitalMode(true);			    // 全局大写命名 ORACLE 注意
	    strategy.setTablePrefix("w_");		    //表前缀
...
//	    strategy.setSuperEntityColumns(new String[] { "test_id", "age" }); 	//自定义实体，公共字段
	    ...
	    strategy.setSuperControllerClass("com.karl.carshop.controller.BaseController");	//自定义继承的Controller类全称，带包名
//
        strategy.setInclude("w_wash_order");                       // 需要生成的表可以多张表
